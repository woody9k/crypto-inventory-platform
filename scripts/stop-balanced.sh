...
# Crypto Inventory Platform - Balanced Performance Stop Script
# This script stops the balanced performance environment to minimize costs

set -e

echo "🛑 Stopping Crypto Inventory Platform (Balanced Performance Mode)..."
...
# Keep Redis at basic tier (already minimal)
echo "🔴 Redis already at basic tier (minimal cost)..."
...
echo "   Current stopped cost: ~$0.20/hour"
echo "   Running cost: ~$0.80/hour"
echo "   Estimated monthly cost (4h/day): ~$72"

echo ""
echo "✅ Balanced performance platform stopped successfully!"
echo "   All compute resources have been scaled down"
echo "   Databases are stopped to minimize costs"
echo "   Use 'scripts/start-balanced.sh' to restart when needed"
echo ""
echo "💡 Cost Savings:"
echo "   - GKE nodes: $0.27/hour saved"
echo "   - Cloud SQL: $0.17/hour saved"
echo "   - Total savings: $0.44/hour when stopped"
